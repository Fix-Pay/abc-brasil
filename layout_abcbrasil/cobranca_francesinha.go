...
var historicoFrancesinhaEnum = []HistoricoFrancesinha{
	{"21", "PAGO", "PAGO"},
	{"22", "PAGO APÓS A BAIXA", "PAGO"},
	{"23", "PAGO NO CORRESPONDENTE", "PAGO"},
	{"25", "PAGO EM CARTÓRIO", "PAGO"},
	{"26", "PAGO NO CAIXA", "PAGO"},
	{"27", "PAGO VIA COMPENSAÇÃO", "PAGO"},
	{"28", "PAGO EM CARTÓRIO (CORRESPONDENTE)", "PAGO"},
	{"29", "PAGO VIA DOC/SPB", "PAGO"},
	{"42", "BAIXA PARA ACERTOS", "BAIXA"},
	{"43", "BAIXADO POR TER SIDO PROTESTADO", "BAIXA"},
	{"44", "BAIXADO PARA DEVOLUÇÃO", "BAIXA"},
	{"48", "BAIXADO POR TER SIDO PAGO DIRETO AO CEDENTE", "BAIXA"},
	{"49", "BAIXADO PARA SUBSTITUIÇÃO", "BAIXA"},
	{"50", "BAIXADO POR FALTA DE SOLUÇÃO", "BAIXA"},
	...
	{"0103", "ENTRADA DE COBRANÇA EXPRESSA NA BXA", "ENTRADA"},
